(function ($) {
   ...
   -------------------------------------------*/
    ...
    //  hover-active
    let items = document.querySelectorAll('.law-service-section .law-service-wrap .law-service-item');
    ...
    /*------------------------------------------
           = Service SLIDER
       -------------------------------------------*/
       if ($(".dc-service-slider").length) {
        $(".dc-service-slider").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
     ...
     /*------------------------------------------
   dc-testimonial-active
   -------------------------------------------*/
   if ($(".dc-testimonial-active").length) {
    $(".dc-testimonial-active").owlCarousel({
        autoplay: true,
        items: 1,
        smartSpeed: 300,
        margin: 50,
        ...
        center: true,
        nav: false,
        navText: ['<i class="fi flaticon-left-arrow-2"></i>', '<i class="fi flaticon-next"></i>'],
    });
}
